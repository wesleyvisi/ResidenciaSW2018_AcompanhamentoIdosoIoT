...
class Settings(object):
    ...
    def __init__(self):
        ...
        self.cameras = [    #Lista de cameras
                [ 
                    "Sala",     #Nome do comodo
                    0,#"rtsp://192.168.1.109:554/user=admin&password=raspcam&channel=1&stream=0.sdp?",     #IP da camera
                    Settings.ANGULO_CAMERA_0,   #Angulo da camera
                    0.7,    #proporção da imagem - 1 = largura e altura original, 0.5 metade da largura e metade da altura original
